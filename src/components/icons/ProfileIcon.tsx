...
export const ProfileIcon = ({ className = '', ...props }) => {
  return (
    ...
    >
      <path 
        d="M12.12 12.78C12.05 12.77 11.96 12.77 11.88 12.78C10.12 12.72 8.72 11.28 8.72 9.50C8.72 7.69 10.18 6.23 12 6.23C13.81 6.23 15.28 7.69 15.28 9.50C15.27 11.28 13.88 12.72 12.12 12.78Z" 
        stroke="currentColor" 
        strokeWidth="1.5" 
        strokeLinecap="round" 
